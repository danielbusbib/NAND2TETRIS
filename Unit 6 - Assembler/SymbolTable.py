...
class SymbolTable:
    ...
    numeric addresses.
    """
    PRE_DEFINED_SYMBOLS = {"R0": 0, "R1": 1, "R2": 2, "R3": 3, "R4": 4, "R5": 5, "R6": 6, "R7": 7, "R8": 8, "R9": 9,
                           "R10": 10, "R11": 11, "R12": 12, "R13": 13, "R14": 14, "R15": 15, "KBD": 24576,
                           "SCREEN": 16384, "ARG": 2, "SP": 0, "LCL": 1, "THIS": 3, "THAT": 4}
    ...
    def pre_defined(self):
        return SymbolTable.PRE_DEFINED_SYMBOLS
    ...
    def contains(self, symbol: str) -> bool:
        ...
        """
        # Your code goes here!
        return True if self.symbols[symbol] else False
    ...
    def get_address(self, symbol: str) -> int:
        ...
        """
        # Your code goes here!
        if symbol in SymbolTable.PRE_DEFINED_SYMBOLS:
            return SymbolTable.PRE_DEFINED_SYMBOLS[symbol]
